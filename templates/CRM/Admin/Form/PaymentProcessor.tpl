...
<div class="crm-block crm-form-block crm-paymentProcessor-form-block">
    ...
    <table class="form-layout-compressed">
        ...
        <tr class="crm-paymentProcessor-form-block-payment_mode crm-select2">
            <td class="label">{$form.payment_mode.label}</td><td>{$form.payment_mode.html}<br />
            </td>
        </tr>
        <tr class="crm-paymentProcessor-form-block-void_avs">
            <td class="label">{$form.void_avs.label}</td><td>{$form.void_avs.html}<br />
                <span class="description">{$form.void_avs.ts}</span></td>
        </tr
        <tr class="crm-paymentProcessor-form-block-void_cvv">
            <td class="label">{$form.void_cvv.label}</td><td>{$form.void_cvv.html}<br />
                <span class="description">{$form.void_cvv.ts}</span></td>
        </tr>
